  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-900 flex flex-col">
      <nav className="px-6 py-5 flex items-center justify-between">
        ...
        <Link href="/inscription" className="text-white/60 hover:text-white text-sm">
          Pas de compte ? <span className="text-blue-400 font-semibold">S&apos;inscrire</span>
        </Link>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-white/50">Connectez-vous à votre espace</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Link href="/mot-de-passe-oublie" className="text-xs text-blue-400 hover:text-blue-300">Oublié ?</Link>
                </div>
                <div className="relative">
              ...
              <button type="submit" disabled={loading || !email || !password}
                className="w-full bg-blue-600 hover:bg-blue-500 disabled:opacity-40 text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 transition-colors mt-2">
                {loading ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <>Se connecter <ArrowRight className="w-4 h-4" /></>}
              </button>
            </form>
          </div>
          <p className="text-center text-white/30 text-sm mt-6">
            Pas encore de compte ?{' '}
            <Link href="/inscription" className="text-blue-400 hover:text-blue-300 font-semibold">Créer un compte</Link>
          </p>
        </div>
      </div>
    </div>
